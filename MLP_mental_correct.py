...
features = ['SleepHours', 'Tired', 'Excited', 
            'Motivated', 'Depression','Anxiety','correctness',"difficulty", 'reading_time']
merged_data = merged_data[features].dropna()  
print(merged_data.shape)

scaler = MinMaxScaler()
merged_data[['SleepHours', 'Tired', 'Excited', 
            'Motivated', 'Depression','Anxiety',"difficulty", 'reading_time']] = scaler.fit_transform(
    merged_data[['SleepHours', 'Tired', 'Excited', 
            'Motivated', 'Depression','Anxiety',"difficulty", 'reading_time']])
print(merged_data.head)

personality_features = merged_data[['SleepHours', 'Tired', 'Excited', 
            'Motivated', 'Depression','Anxiety',"difficulty", 'reading_time']].values
personality_features = personality_features.astype(float)
y_binary = (merged_data['correctness'] > 0.5).astype(int)  
...
print("Target variable y shape:", y_binary.shape)
print(y_binary)
...
# Evaluate
feature_names = ['SleepHours', 'Tired', 'Excited', 
            'Motivated', 'Depression','Anxiety',"difficulty", 'reading_time']
