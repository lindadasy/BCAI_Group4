...
merged_data = pd.merge(user_data, 
                       ...
                       right_on='id', 
                       how='inner')
features = ["id",'Extraversion', 'Agreeableness', 'Conscientiousness', 
            'Neuroticism', 'OpennessToExperience', 'correctness',"difficulty", 'reading_time']
...
model = smf.mixedlm(
    "correctness ~ Extraversion + Agreeableness + Conscientiousness + Neuroticism + OpennessToExperience + difficulty + reading_time",
    data=merged_data,
